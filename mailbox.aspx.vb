...
Partial Class mailbox
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            If Not Request.Form("name") Is Nothing Then
                ...
                Result = Mail(Request.Form("name"), Request.Form("phone"), Request.Form("subject"), Request.Form("emails"), Request.Form("message"))
    ...
    'End Sub
    Private Shared Function Mail(ByVal name As String, ByVal phone As String, ByVal subject As String, ByVal emails As String, ByVal message As String) As String
        ...
        templateVars.Add("Subject", subject)
        templateVars.Add("Message", message)
        'Result = Email.SendEmail("contact_email.htm", templateVars, "website@aspiretechnosys.com", "emsatsolution@gmail.com", "Website Enquiry", "")
